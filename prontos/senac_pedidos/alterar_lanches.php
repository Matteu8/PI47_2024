...
if (isset($_GET["id_alterar"])) {
    ...
    $stmt = $mysqli->prepare("SELECT * FROM pi_2024_pedidos_lanches WHERE id_lanches = ?");
    ...
    if (isset($_POST["nome"])) {
        ...
        $stmt = $mysqli->prepare("UPDATE pi_2024_pedidos_lanches SET nome = ?, ingredientes = ?, preco = ?, quantidade = ?, foto = ? WHERE id_lanches = ?");
