...
$consultar_banco = "SELECT id, nome, tipo, preco, foto, quantidade FROM pi_2024_pedidos_bebidas LIMIT $inicio, $limite";
$retorno_consulta = $mysqli->query($consultar_banco) or die($mysqli->error);

// Contagem total de bebidas
$consulta_total = $mysqli->query("SELECT COUNT(*) as total FROM pi_2024_pedidos_bebidas");
...
<head>
    ...
    <title>Senac-PR - Lista Bebidas</title>
