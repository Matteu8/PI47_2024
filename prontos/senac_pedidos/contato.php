...
if (isset($_SESSION["id_cliente"])) {
    $stmt = $mysqli->prepare("SELECT nome, email, telefone FROM pi_2024_pedidos_clientes WHERE id_clientes = ?");
...
if (isset($_POST["bt_nome"])) {
    ...
    $stmt = $mysqli->prepare("INSERT INTO pi_2024_pedidos_feedback (nome, email, telefone, assunto, msg) VALUES (?, ?, ?, ?, ?)");
