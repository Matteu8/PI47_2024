...
if (isset($_GET['delete_id'])) {
    ...
    $stmt = $mysqli->prepare("DELETE FROM pi_2024_pedidos_feedback WHERE id_feedback = ?");
...
$resultado = $mysqli->query("SELECT * FROM pi_2024_pedidos_feedback ORDER BY id_feedback ASC");
?>
