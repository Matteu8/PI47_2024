...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 09-Set-2024 às 19:37
...
(1, 'Bolo de Chocolate', 'ovos, aÃ§Ãºcar, farinha de trigo, chocolate em pÃ³, Margarina com sal, fermento em pÃ³, sal, leite', 'R$ 7,00', 'Lanches/img/66df30d421b2b.jpg'),
(2, 'X-Salada', 'pÃ£o, salada, hamburger, tomate', 'R$ 15,00', 'Lanches/img/66df3536dc13f.png');
COMMIT;
