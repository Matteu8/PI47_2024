<?php
    ...
    //$sobremesa = "SELECT * FROM sobremesas";
...
<head>
    ...
    <style>
        ...
        h1 { font-size: 28px; font-weight: bold; margin-bottom: 20px; text-align: center; color: #333; }
        .row { margin-bottom: 20px; }
        .card { transition: transform 0.3s; }
        .card:hover { transform: scale(1.05); }
        .card-img-top { border-radius: 8px; height: 300px; object-fit: cover; }
        .btn-primary { background-color: #007bff; border: none; transition: background-color 0.3s ease; }
        .btn-primary:hover { background-color: #0056b3; }
        .btn { border-radius: 5px; padding: 10px 15px; font-size: 14px; }
        .img-thumbnail { width: 100px; height: 100px; object-fit: cover; border-radius: 50%; }
    </style>
</head>
<body>
        ...
        <div class="row">
            <?php while ($lanche = $lanches_result->fetch_assoc()) { ?>
                <div class="col-md-3 mb-4"> 
                    <div class="card">
                        <img src="<?php echo htmlspecialchars($lanche['foto']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($lanche['nome']); ?>">
                        <div class="card-body">
                            ...
                            <?php if (isset($_SESSION['tipo_usuario'])):?>
                             ...
                             <?php else: ?>
                                <div class="alert alert-danger" role="alert">Você não esta logado, faça login para pedir</div>
    ...
    <div class="container">
        <div class="row">
            <?php while ($sobremesa = $sobremesa_result->fetch_assoc()) { ?>
                <div class="col-md-3 mb-4"> 
                    <div class="card">
                        <img src="<?php echo htmlspecialchars($sobremesa['foto']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($sobremesa['nome']); ?>">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo htmlspecialchars($sobremesa['nome']); ?></h5>
                            <p class="card-text">Tipo: <?php echo htmlspecialchars($sobremesa['tipo']); ?></p>
