<?php
    ...
    if(isset($_POST["bt_nome"])){
        ...
        if (isset($_FILES["foto"]) && $_FILES["foto"]["error"] == 0) {
            ...
            $mysqli->query("INSERT INTO bebidas (nome, ingredientes, preco, foto) values('$nome','$curso', '$periodo','$caminhoFinal')") or
                    die($mysqlierrno);
...
<body>
    ...
    <div class="container mt-5 d-flex justify-content-center">
        ...
        <form class="form" method="post" enctype="multipart/form-data">
            ...
            <label>
                <input required="" placeholder="" type="text" class="input" name="bt_curso">
                <span>Email:</span>
            </label>

            <label>
                <input required="" placeholder="" type="text" class="input" name="bt_periodo">
                <span>Período:</span>
            </label>
